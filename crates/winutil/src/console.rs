...
/// For a Windows-subsystem program, which starts without a console: sends output that goes
/// nowhere to the parent's console, if it has one. Redirected output is left alone. Whether
/// output now goes anywhere.
